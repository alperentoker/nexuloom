...
export const translations = {
  tr: {
    ...
    navScheduler: "Zamanlanmış Görevler",
    navDrift: "Veri & Şema Kayması",
    navCustomDashboard: "Özel Pano (Custom BI)",
    ...
    // Scheduler Tab
    schedulerTitle: "Zamanlanmış Görev & Otomasyon Motoru",
    schedulerDesc: "Gece veri kalitesi ve anomali taramaları, aylık yönetici PDF/Excel derlemeleri ve arka plan görevleri.",
    btnAddJob: "+ Yeni Otomasyon Görevi",
    colJobName: "Görev Tanımı",
    colJobType: "Görev Türü",
    colSchedule: "Tetikleyici / Cron",
    colTargetDb: "Hedef DB",
    ...
    btnResume: "▶ Başlat",
    btnDeleteJob: "🗑️ Sil",
    schedulerHistoryTitle: "Görev Yürütme Denetim Geçmişi",
    historyJobName: "Görev Adı",
    historyStarted: "Başlangıç",
    historyFinished: "Bitiş",
    historyStatus: "Durum",
    historyDetails: "Detaylar & Sonuç",

    // Drift Tab
    driftTitle: "Veri Dağılımı ve Şema Kayma Takibi (DataOps / MLOps)",
    driftDesc: "Tablo yapılarındaki değişimler (eklenen/silinen kolonlar) ve sayısal metriklerdeki istatistiksel sapmalar (KS-Testi).",
    btnTakeSnapshot: "📸 Anlık Referans Snapshot Al",
    schemaDriftSubTitle: "Zaman İçinde Şema Değişimleri (Schema Drift)",
    dataDriftSubTitle: "İstatistiksel Dağılım Kaymaları (Kolmogorov-Smirnov Testi)",
    colTableName: "Tablo Adı",
    colDriftStatus: "Durum",
    colAddedCols: "Eklenen Kolonlar",
    colRemovedCols: "Silinen Kolonlar",
    colModifiedCols: "Tipi Değişenler",
    colBaselineDate: "Referans Tarihi",
    colColumnName: "Kolon",
    colKsStat: "KS İstatistiği",
    colPValue: "p-Değeri",
    colMeanShift: "Ortalama Sapması",
    colStdShift: "Std Sapması",
    colDistributionSummary: "Dağılım Özeti",

    // Custom BI Dashboards Tab
    customDashTitle: "Özel BI Panosu & Dinamik Bileşenler (Custom BI Grid)",
    customDashDesc: "DuckDB, Parquet ve ilişkisel veritabanları üzerinde özel SQL sorgularıyla canlı grafik ve KPI oluşturun.",
    btnAddWidget: "+ Yeni Bileşen Ekle",
    btnRefreshWidgets: "🔄 Verileri Yenile",
    modalAddWidgetTitle: "Yeni Grafik veya KPI Bileşeni Ekle",
    lblWidgetTitle: "Bileşen Başlığı",
    lblWidgetType: "Bileşen Türü",
    lblTargetDb: "Hedef Veritabanı",
    lblSqlQuery: "Salt-Okunur SQL Sorgusu",
    lblWidgetWidth: "Genişlik (1-12)",
    lblXCol: "X Ekseni / Kategori Kolonu",
    lblYCol: "Y Ekseni / Değer Kolonu",
    lblPrefix: "Değer Öneki (örn: $ veya ₺)",
    lblSuffix: "Değer Soneki (örn: adet veya %)",
    btnPreviewWidget: "👁️ Önizle",
    btnSaveWidget: "Kaydet & Panoya Ekle",
    kpiCardType: "KPI Metrik Kartı",
    barChartType: "Çubuk Grafik (Bar Chart)",
    lineChartType: "Çizgi Grafik (Line Chart)",
    donutChartType: "Halka Grafik (Donut Chart)",
    tableType: "SQL Sonuç Tablosu",
  },
  en: {
    // Brand
    brandTitle: "Nexuloom",
    ...
    navScheduler: "Scheduled Tasks & Cron",
    navDrift: "Data & Schema Drift",
    navCustomDashboard: "Custom BI Dashboard",
    ...
    // Scheduler Tab
    schedulerTitle: "Scheduled Task & Automation Engine",
    schedulerDesc: "Automated nightly quality/anomaly scans, monthly executive PDF/Excel dossiers, and periodic background runs.",
    btnAddJob: "+ New Automation Task",
    colJobName: "Task Description",
    colJobType: "Task Type",
    colSchedule: "Trigger / Cron",
    colTargetDb: "Target DB",
    colNextRun: "Next Run",
    colLastRun: "Last Run",
    ...
    btnPause: "⏸ Pause",
    btnResume: "▶ Resume",
    btnDeleteJob: "🗑️ Delete",
    schedulerHistoryTitle: "Scheduled Task Execution Audit Log",
    historyJobName: "Task Name",
    historyStarted: "Started",
    historyFinished: "Finished",
    historyStatus: "Status",
    historyDetails: "Details & Outcome",

    // Drift Tab
    driftTitle: "Data & Schema Drift Tracking (DataOps / MLOps)",
    driftDesc: "Structural table mutations (added/removed columns) and statistical distribution divergences (Kolmogorov-Smirnov test).",
    btnTakeSnapshot: "📸 Capture Baseline Snapshot",
    schemaDriftSubTitle: "Schema Structural Mutations Over Time",
    dataDriftSubTitle: "Statistical Distribution Divergence (Kolmogorov-Smirnov Test)",
    colTableName: "Table Name",
    colDriftStatus: "Status",
    colAddedCols: "Added Columns",
    colRemovedCols: "Removed Columns",
    colModifiedCols: "Type Alterations",
    colBaselineDate: "Baseline Date",
    colColumnName: "Column",
    colKsStat: "KS Statistic",
    colPValue: "p-Value",
    colMeanShift: "Mean Shift",
    colStdShift: "Std Shift",
    colDistributionSummary: "Distribution Summary",

    // Custom BI Dashboards Tab
    customDashTitle: "Custom BI Dashboard & Dynamic Widgets",
    customDashDesc: "Build customized KPI cards, live charts, and query tables powered by DuckDB, Parquet, and RDBMS engines.",
    btnAddWidget: "+ Add Widget",
    btnRefreshWidgets: "🔄 Refresh Live Data",
    modalAddWidgetTitle: "Add Chart or KPI Metric Widget",
    lblWidgetTitle: "Widget Title",
    lblWidgetType: "Widget Type",
    lblTargetDb: "Target Database",
    lblSqlQuery: "Read-Only SQL Query",
    lblWidgetWidth: "Grid Width (1-12)",
    lblXCol: "X-Axis / Category Column",
    lblYCol: "Y-Axis / Value Column",
    lblPrefix: "Prefix (e.g. $ or ₺)",
    lblSuffix: "Suffix (e.g. units or %)",
    btnPreviewWidget: "👁️ Preview",
    btnSaveWidget: "Save & Pin to Dashboard",
    kpiCardType: "KPI Metric Card",
    barChartType: "Bar Chart",
    lineChartType: "Line Chart",
    donutChartType: "Donut Chart",
    tableType: "SQL Result Table",
  }
};
